...
e2e_Tests() {
    ...
    gulp test-headless || err_and_exit "ERROR!!! test-headless failed"
    ...
    DEVMODE=true gulp channel-init || err_and_exit "ERROR!!! channel-init failed"
    gulp test-devmode || err_and_exit "ERROR!!! test-devmode failed"
    ...
    DEVMODE=true gulp channel-init || err_and_exit "ERROR!!! channel-init failed"
    gulp test-invctrl || err_and_exit "ERROR!!! test-invctrl failed"
